...
/// you'll probably need to remove `PartialEq`, `Eq`, `PartialOrd`, `Ord`
/// from the `derive` list, and either implement them manually or redesign
/// the code that uses overlays as hash table keys.)
